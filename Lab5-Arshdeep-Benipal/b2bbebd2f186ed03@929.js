// https://observablehq.com/@mootari/range-slider@929
import define1 from "./e93997d5089d7165@2173.js";
import define2 from "./3d9d1394d858ca97@403.js";
import define3 from "./e93997d5089d7165@2225.js";
...
${Object.entries({
  ...
  theme: 'Widget CSS, string. Optional, defaults to [<code>theme_GoogleChrome_MacOS1013</code>](#theme_GoogleChrome_MacOS1013).',
}).map(([k,v]) => `- \`${k}:\` ${v}\n`)}

`
})
)});
  main.variable(observer("rangeInput")).define("rangeInput", ["theme_GoogleChrome_MacOS1013","randomScope","DOM","html","clamp","invalidation"], function(theme_GoogleChrome_MacOS1013,randomScope,DOM,html,clamp,invalidation){return(
function rangeInput(options = {}) {
  const {
    ...
    step = 1,
    value = [min, max],
    theme = theme_GoogleChrome_MacOS1013,
  } = options;
...
signature('theme_GoogleChrome_MacOS1013', {
  ...
  description: `Default CSS theme. Matches the style of range inputs in Google Chrome on macOS 10.13.`
})
)});
...
function clamp(a, b, v) {
  ...
  main.variable(observer("themes")).define("themes", ["theme_GoogleChrome_MacOS1013","theme_NoUiSlider","theme_Retro1"], function(theme_GoogleChrome_MacOS1013,theme_NoUiSlider,theme_Retro1){return(
{
